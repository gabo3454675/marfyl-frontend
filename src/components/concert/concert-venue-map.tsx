        ...
        <div className="venue-mesa-panel" id="mesa-panel">
          <div className={cn('venue-mesa-panel-header', tierClass(activeDef.tier))}>
            ...
            <p className="text-sm opacity-90">
              USD {activeDef.priceUsd} · Bs {activeDef.priceBs}
              {' · '}
